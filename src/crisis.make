...
CRISIS_EXE_CONFIG_SOURCE=app.config
...
ifeq ($(CONFIG),CRISIS_X86)
ASSEMBLY_COMPILER_COMMAND = dmcs
ASSEMBLY_COMPILER_FLAGS =  -noconfig -codepage:utf8 -warn:4 -optimize- -debug "-define:DEBUG;TRACE" "-main:Crisis.Program"
ASSEMBLY = bin/x86/Crisis/crisis.exe
ASSEMBLY_MDB = $(ASSEMBLY).mdb
COMPILE_TARGET = exe
PROJECT_REFERENCES = 
BUILD_DIR = bin/x86/Crisis

CRISIS_EXE_MDB_SOURCE=bin/x86/Crisis/crisis.exe.mdb
CRISIS_EXE_MDB=$(BUILD_DIR)/crisis.exe.mdb
CRISIS_EXE_CONFIG_SOURCE=app.config
...
ifeq ($(CONFIG),CRISIS_X64)
ASSEMBLY_COMPILER_COMMAND = dmcs
ASSEMBLY_COMPILER_FLAGS =  -noconfig -codepage:utf8 -warn:4 -optimize- "-main:Crisis.Program"
ASSEMBLY = bin/x64/Crisis/crisis.exe
ASSEMBLY_MDB = 
COMPILE_TARGET = exe
PROJECT_REFERENCES = 
BUILD_DIR = bin/x64/Crisis
...
CRISIS_EXE_CONFIG = $(BUILD_DIR)/crisis.exe.config
...
$(eval $(call emit-deploy-target,CRISIS_EXE_CONFIG))
...
install-local: $(ASSEMBLY) $(ASSEMBLY_MDB)
	...
	$(call cp,$(CRISIS_EXE_CONFIG),$(DESTDIR)$(libdir)/$(PACKAGE))
...
uninstall-local: $(ASSEMBLY) $(ASSEMBLY_MDB)
	...
	$(call rm,$(CRISIS_EXE_CONFIG),$(DESTDIR)$(libdir)/$(PACKAGE))
