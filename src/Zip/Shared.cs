...
namespace crisis.Ionic.Zip
{
    ...
    internal static class SharedUtilities
    {
        ...
        ///   CrisisZip-xxxxxxxx.tmp, where xxxxxxxx is replaced by randomly
        ...
        {
            return "CrisisZip-" + GenerateRandomStringImpl(8,0) + ".tmp";
        }
        ...
        public static string InternalGetTempFileName()
        {
            return "CrisisZip-" + Path.GetRandomFileName().Substring(0, 8) + ".tmp";
        }
    ...
    public class CountingStream : System.IO.Stream
    {
        ...
        public override long Position
        {
            ...
            set
            {
                ...
                // workitem 10178
                crisis.Ionic.Zip.SharedUtilities.Workaround_Ladybug318918(_s);
            }
        }
